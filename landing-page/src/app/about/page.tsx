  ...
  return (
    <>
      ...
      <main className="min-h-screen w-full overflow-hidden bg-background text-foreground">
        {/* Our Vision Section */}
        <Section
          className="pt-24 pb-16 md:pt-32 md:pb-24 relative animate-appear opacity-0"
          id="vision"
        >
          <div className="max-w-container mx-auto px-4">
            <div className="text-center space-y-6 max-w-4xl mx-auto relative z-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed text-lg animate-appear opacity-0 delay-200">
                <p>
                  GrantWare AI&apos;s mission is to empower school districts
                  with intelligent tools that simplify the entire grant
                  lifecycle. We believe that every district deserves access to
                  funding opportunities that can transform their communities. We
                  are all so different, yet each district faces similar
                  challenges when it comes to discovering, applying for, and
                  managing grants. GrantWare AI is putting an end to the
                  one-size-fits-all model. Through looking at each district with
                  a holistic lens, we believe we can use the power of AI & ML to
                  match districts with the perfect grants and streamline the
              ...
              <div className="bg-background rounded-2xl p-8 md:p-12 shadow-sm border border-border">
                <div className="flex flex-col items-center text-center space-y-6">
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
                    ...
                    open source solutions, using a community-powered approach to
                    deliver high-performing Linux, cloud, container, and
                    Kubernetes technologies. Red Hat&apos;s support empowers
                    GrantWare AI to build on cutting-edge, reliable
                    infrastructure that serves school districts with
