...
export function CTASection({ onScheduleDemo }: CTASectionProps) {
  return (
        ...
        >
          <div className="text-center">
            ...
            <p className="text-base sm:text-lg text-[#696969] leading-relaxed mb-8 max-w-4xl mx-auto">
              GrantWare AI is currently in <strong>beta</strong>,{" "}
              <strong>schedule a call</strong> to join our Contributor Program
              and get early access: receive weekly updates, resources, and
              feedback forms; help pilot our platform and provide feedback to
              shape its development; early contributors may secure{" "}
              <strong>priority access and discounted first-year pricing</strong>
              . Don&apos;t miss the chance to be among the first to experience
              and contribute to a smarter, AI-powered grant platform.
            </p>
